...
import { DynamicTable3Service } from '../services/dynamic-table3.service';

@Component({
  selector: 'app-Dynamictable3Component',
  templateUrl: './dynamic-table3.component.html',
  providers: [DynamicTable3Service]
})
export class DynamicTable3Component implements OnInit {
  ...
  readonly breadcrumb: PoBreadcrumb = {
    items: [{ label: 'Home', link: '/' }, { label: 'Manager3' }]
  };
  ...
  constructor(private usersService: DynamicTable3Service) {}
